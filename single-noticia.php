      ...
      <div class="col-lg-8 section-divided__main">
        ...
        <section class="section-md post-single-body">
          ...
          <p class="first-letter">
            ...
            <?php
            $content_post = get_post($current_object);
            $content = $content_post->post_content;
            // function addFilterContent($contentFilter){
            //   // echo "THIS SHIT" . $contentFilter . " END SHIT";
            // }
            // add_filter("the_content", "addFilterContent");
