      ...
      <div class="col-md-6 col-lg-3">
        ...
        <article class="blurb blurb-circle blurb-circle_centered">
          <div class="blurb-circle__icon"><span class="icon">
              <img src="<?php echo $service["icono"] ?>" alt="<?php echo $service["titulo"] ?>">
            </span></div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7 col-lg-5 image-none">
          <figure class="button-shadow"><img src="<?php the_field("nuestro_talento_imagen", $currentObject)  ?>" alt="" width="555" height="800">
          </figure>
        </div>
      </div>
    </div>
    ...
    <div class="row row-50">
      ...
      <div class="col-md-6">
        ...
        <div class="quote-default quote-default_left">
          <div class="quote-default__image"><img src="<?php echo $testimonio["imagen"]["url"] ?>" alt=""  />
          </div>
